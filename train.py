...
MODEL_NAME = 'gtafly-{}-{}-{}-epochs-{}-data.model'.format(LR, 'googlenet',EPOCHS,FILE_I_END)
PREV_MODEL = 'gtafly-0.001-googlenet-30-epochs-8-data.model'
LOAD_MODEL = True
...
for e in range(EPOCHS):
    ...
    for count,i in enumerate(data_order):
        ...
        try:
            file_name = 'bal/training_data-{}.npy'.format(i)
            # full file info
